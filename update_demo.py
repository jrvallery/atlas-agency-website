...
old_section = """<section class="py-20 px-4">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold mb-4">See It In Action</h2>
            <p class="text-gray-400 mb-10">Ask our demo AI anything about our services, pricing, or how we can help your business.</p>
            <div id="chat-widget" class="bg-slate border-2 border-dashed border-electric/40 rounded-2xl min-h-[420px] flex flex-col items-center justify-center text-gray-500 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center gap-4 p-8">
                    <div class="w-16 h-16 bg-electric/10 border border-electric/30 rounded-2xl flex items-center justify-center">
                        <svg class="w-8 h-8 text-electric" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                    </div>
                    <p class="text-lg font-semibold text-gray-300">OpenClaw Webchat Widget</p>
                    <p class="text-sm text-gray-500 max-w-xs text-center">This area loads the live AI chat agent once the OpenClaw widget script is configured.</p>
                    <a href="contact.html" class="mt-2 bg-electric/20 hover:bg-electric/30 border border-electric/40 text-accent font-medium px-5 py-2.5 rounded-lg text-sm transition-colors">Talk to us instead →</a>
                </div>
            </div>
        </div>
    </section>"""
